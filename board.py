...
class Board:
    ...
    def init_row11(self):
        correction = {
            (11, 30): {1: [(10, 30), (11, 30)], 3: [(8, 30), (12, 28)], 5: [(6, 30), (10, 28), (12, 26)]},
            (11, 28): {1: [(10, 28), (12, 28)], 3: [(13, 27), (12, 26)], 5: [(6, 28), (15, 27), (12, 24)]},
            ...
            (11, 20): {1: [(11, 19)], 3: [(12, 18)], 5: [(12, 20), (11, 17), (14, 18)], PAY: 200},
            # (11, 19): {1: [(11, 18)], 3: [(12, 19), (12, 17), (13, 18)],5: [(15, 18), (12, 21), (13, 20), (10, 17), (11, 16)]},
            (11, 19): {1: [(4, 29)], 3: [(4, 29)],5: [(4, 29)]},
    ...
    def init_row9(self):
        ...
        self.transition_dict[(9, 26)] = {1: [(9,27)], 3:[(7, 26)], 5:[(6,28),(12,28)], JUMP:[]}
        self.transition_dict[(7, 26)] = {1: [(9,27)], 3:[(10,28),(8,28)], 5:[(6,28),(12,28)], JUMP:[], GET: 1500}
    ...
    def init_row6(self):
        ...
        self.transition_dict[(6, 24)] = {1: [(5, 24)], 3: [(5, 22)], 5: [(5, 22)]}
        self.transition_dict[(6, 23)] = {1: [(6, 24)], 3: [(5, 23)], 5: [(5, 22)], PAY: 50}
        self.transition_dict[(6, 22)] = {1: [(6, 21)], 3: [(6, 21)], 5: [(6, 21)]}
        self.transition_dict[(6, 21)] = {1: [(6, 23)], 3: [(5, 24)], 5: [(5, 22)]}
    ...
    def init_row5(self):
        ...
        self.transition_dict[(5, 24)] = {1: [(5,23)], 3: [(5,22)], 5: [(5,22)]}
        self.transition_dict[(5, 23)] = {1: [(5,22)], 3: [(5,22)], 5: [(5,22)]}
        ...
        self.transition_dict[(5, 17)] = {1: [(4,17)], 3: [(5,18),(3,18)], 5: [(7,18),(3,20),(3,16)]}
    ...
    def init_row4(self):
        ...
        self.transition_dict[(4, 25)] = {1: [(5,25),(3,25)], 3: [(6,26),(7,25),(2,26),(1,25)], 5: [(0,26),(0,24),(3,26),(6,28),(7,23),(9,25)]}
        ...
        self.transition_dict[(4, 10)] = {1: [(4,9)], 3: [(5,8),(4,7),(3,8)], 5: [(4,5),(7,8),(3,10),(3,6),(1,8)]}
        ...
        self.transition_dict[(4, 5)] = {1: [(4,4)], 3: [(6,4),(2,4),(3,5)], 5: [(3,7),(7,5),(8,4),(7,3)], PAY: 50}
    ...
    def init_row3(self):
        ...
        self.transition_dict[(3, 25)] = {1: [(2,25),(4,25)], 3: [(0,25),(3,26),(6,25)], 5: [(0,27),(0,23),(3,26),(6,27),(8,25),(7,24)]}
    ...
    def init_row2(self):
        ...
        self.transition_dict[(2, 26)] = {1: [(3,26)], 3: [(3,26)], 5: [(3,26)]}
        self.transition_dict[(2, 25)] = {1: [(3,25),(1,25)], 3: [(5,25),(0,26),(0,24),(3,26)], 5: [(3,26),(0,22),(6,26),(7,25)]}
        ...
        self.transition_dict[(2, 14)] = {1: [(1,14)], 3: [(3,16),(3,14)], 5: [(3,12),(5,16),(3,18)]}
        self.transition_dict[(2, 13)] = {1: [(2,14)], 3: [(1,15)], 5: [(1,15)], PAY: 50}
        self.transition_dict[(2, 12)] = {1: [(1,12)], 3: [(2,13)], 5: [(1,14)]}
        self.transition_dict[(2, 11)] = {1: [(1,11),(3,11)], 3: [(5,11),(3,13),(3,9),(1,13)], 5: [(2,14),(3,15),(7,11),(5,13)]}
        self.transition_dict[(2, 8)] = {1: [(1,8),(3,8)], 3: [(0,9),(3,10),(5,8),(3,6),(4,7)], 5: [(3,12),(4,11),(2,11),(4,5),(7,8),(3,4)]}
        self.transition_dict[(2, 4)] = {1: [(1,4),(3,4)], 3: [(5,4),(3,6)], 5: [(7,4),(3,8)]}


    def init_row1(self):
        self.transition_dict[(1, 25)] = {1: [(0,25),(2,25)], 3: [(0,27),(0,23),(4,25),(3,26)], 5: [(3,26),(0,21),(6,25)]}
        ...
        self.transition_dict[(1, 14)] = {1: [(0,14)], 3: [(0,14)], 5: [(0,14)]}
        self.transition_dict[(0, 14)] = {1: [(1,15)], 3: [(1,15)], 5: [(1,15)]}
        self.transition_dict[(1, 13)] = {1: [(0,13)], 3: [(0,13)], 5: [(0,13)]}
        self.transition_dict[(0, 13)] = {1: [(2,13)], 3: [(1,14)], 5: [(1,15)]}
        self.transition_dict[(1, 12)] = {1: [(0,12)], 3: [(0,12)], 5: [(0,12)], PAY: 50}
        self.transition_dict[(0, 12)] = {1: [(1,13)], 3: [(2,14)], 5: [(1,15)]}
        self.transition_dict[(1, 11)] = {1: [(0,11),(2,11)], 3: [(1,12),(3,12),(3,10),(4,11)], 5: [(1,15),(5,12),(6,11),(3,14),(3,8),(4,9)]}
        self.transition_dict[(1, 8)] = {1: [(0,8),(2,8)], 3: [(0,11),(3,9),(3,7),(4,8)], 5: [(1,11),(3,11),(6,8),(3,5),(4,6)]}
        self.transition_dict[(1, 4)] = {1: [(0,4),(2,4),(1,0)], 3: [(3,5),(4,4)], 5: [(6,4),(3,7),(6,8),(3,5),(4,6)]}
        # starting point
    ...
    def init_row0(self):
        ...
        self.transition_dict[(0, 25)] = {1: [(0,26),(1,25),(0,24)], 3: [(2,26),(3,25),(0,22)], 5: [(3,26),(5,25),(0,20)]}
        ...
        self.transition_dict[(0, 9)] = {1: [(0,11)], 3: [(2,11)], 5: [(3,12),(4,11),(3,10)]}
