...
class Board:
    ...
    def init_row6(self):
        ...
        self.transition_dict[(6, 23)] = {1: [(6, 24)], 3: [(5, 23)], 5: [(6, 23)], PAY: 50}
        self.transition_dict[(6, 22)] = {1: [(6, 23)], 3: [(5, 24)], 5: [(5,22)], WAIT: 1, ORANGE: (5,22)}
    ...
    def init_row5(self):
        ...
        self.transition_dict[(5, 11)] = {1: [(5,12),(4,11),(6,11)], 3: [(5, 11),(3,12),(2,11),(3,10),(7,12),(7,10)], 5: [(7,14),(3,14),(11,0),(3,8),(7,8),(8,9)]}
    ...
    def init_row3(self):
        ...
        self.transition_dict[(3, 12)] = {1: [(3,13),(3,11)], 3: [(3,15),(1,13),(1,11),(5,11),(4,10),(3,9)], 5: [(3,17),(4,8),(2,8),(3,7),(7,11)], ORANGE: (5,13)}
        ...
        self.transition_dict[(3, 8)] = {1: [(3,9),(3,7),(4,8),(2,8)], 3: [(6,8),(3,11),(3,5),(0,8),(4,6)], 5: [(3,13),(1,11),(4,4),(2,4),(7,9),(7,7),(5,11)], ORANGE: (4,5)}
