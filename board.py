...
class Board:
    ...
    def init_row10(self):
        ...
        self.transition_dict[(10, 21)] = {1: [(11,21),(9,21)], 3:[(12,20), (12,22),(8,20),(7,21)], 5:[(7,23),(7,19),(14,20),(12,18),(12,24)], ORANGE:(8,20)}
    ...
    def init_row8(self):
        ...
        self.transition_dict[(8, 8)] = {1: [(8,9),(9,8),(7,8),(7,8)], 3:[(9,7),(7,10),(11,8),(7,6)], 5:[(12,7),(7,4),(6,11),(7,12),(12,9),(8,8),(9,5)], ORANGE: (9,5)}
    ...
    def init_row7(self):
        ...
        self.transition_dict[(7, 24)] = {1: [(7, 25),(7,23)], 3: [(7,21),(6,22), (9,25),(5,25),(6,26)], 5: [(8,20), (9,21), (7,19) ,(6,20),(11,25),(6,28),(3,25),(6,24)], ORANGE:(8,20)}
        self.transition_dict[(7, 23)] = {1: [(7, 24),(7,22)], 3: [(8,21), (7,20),(8,25),(6,25)], 5: [(10,25), (6,27), (4,25) ,(10,21),(7,18),(5,20)]}
        self.transition_dict[(7, 22)] = {1: [(7, 23),(7,21),(6,22)], 3: [(7,25), (8,20),(9,21),(7,19),(6,20),(6,24)], 5: [(9,25), (6,26), (5,25) ,(4,20),(6,18),(11,21),(5,20),(5,23)],ORANGE:(8,20)}
        self.transition_dict[(7, 21)] = {1: [(7, 22),(7,20),(8,21)], 3: [(7,24), (10,21),(7,18),(5,20)], 5: [(8,25), (6,25) ,(12,21),(5,18),(3,20)]}
        self.transition_dict[(7, 20)] = {1: [(7, 21),(7,19),(6,20)], 3: [(6,18), (4,20),(8,20),(7,23),(7,17),(6,22)], 5: [(7,25), (2,20), (4,18),(11,21),(6,16),(17,15),(9,17),(6,24)],ORANGE:(8,20)}
        self.transition_dict[(7, 19)] = {1: [(7, 20),(7,18)], 3: [(5,18), (5,20),(7,22),(8,21),(7,16)], 5: [(7,24), (10,21) ,(3,20),(3,18),(10,17),(9,16),(5,16),(7,14)]}
        self.transition_dict[(7, 18)] = {1: [(7, 19),(7,17),(6,18)], 3: [(7,21), (6,20),(4,18),(7,15),(9,17),(8,16)], 5: [(8,20), (7,23), (4,20),(9,21),(3,17),(11,17),(10,16),(7,13),(5,16)],ORANGE:(8,20)}
        ...
        self.transition_dict[(7, 12)] = {1: [(7, 13),(7,11)], 3: [(7,9), (8,10),(7,15)], 5: [(7,17), (8,16), (6,16),(7,7),(8,8),(6,8),(9,9),(5,13)] ,ORANGE:(5,13)}
        self.transition_dict[(7, 11)] = {1: [(7, 12),(7,10),(6,11)], 3: [(7,13), (4,11),(7,8),(8,9)], 5: [(7,16), (2,11),(3,10),(8,8),(7,6)]}
        self.transition_dict[(7, 10)] = {1: [(7, 11),(8,10),(7,9)], 3: [(7,13), (5,11),(7,7),(6,8),(9,9)], 5: [(7,15), (5,13),(3,11),(7,5),(8,8),(9,9),(10,8)],ORANGE:(5,13)}
        self.transition_dict[(7, 9)] = {1: [(8,9),(7,10),(7,8)], 3: [(10,9), (8,7),(7,12),(7,6),(5,8)], 5: [(12,9), (9,6),(8,13),(7,14),(3,8)]}
        self.transition_dict[(7, 8)] = {1: [(7,9),(8,8),(6,8),(7,7)], 3: [(8,10), (7,11),(4,8),(7,5),(10,8)], 5: [(7,13), (11,9),(12,8),(8,4),(7,3),(6,4),(3,9),(2,8),(3,7)]}
    ...
    def init_row6(self):
        ...
        self.transition_dict[(6, 20)] = {1: [(5, 20),(7,20)], 3: [(7,22),(3,22),(7,18),(8,21)], 5: [(3, 18),(1,20),(5,18),(10,21),(7,24)]}
        ...
        self.transition_dict[(6, 11)] = {1: [(7, 11),(5,11)], 3: [(3,11),(7,13),(7,9),(8,10),(5,13)], 5: [(3, 13),(3,9),(1,11),(7,15),(8,8),(7,7),(9,9)], ORANGE: (5,13)}
    ...
    def init_row5(self):
        ...
        self.transition_dict[(5, 25)] = {1: [(6, 25), (4,25)], 3: [(6,27),(2,25),(8,25),(7,24)], 5: [(5,28),(7,28),(10,25),(7,22),(0,25),(3,26)], ORANGE:(3,26)}
        self.transition_dict[(5, 24)] = {1: [(5,23)], 3: [(5,24)], 5: [(5,24)]}
        self.transition_dict[(5, 23)] = {1: [(5,22)], 3: [(5,23)], 5: [(5,23)], ORANGE: (5,22)}
        self.transition_dict[(5, 22)] = {1: [(5,21)], 3: [(6,20),(4,20)], 5: [(7,21),(7,19),(2,20),(3,19),(8,20)], ORANGE: (8,20), HAS: Certificate.ID}
        self.transition_dict[(5, 21)] = {1: [(5,20)], 3: [(7,20),(3,20)], 5: [(7,18),(7,22),(8,21),(3,18),(1,20)]}
        self.transition_dict[(5, 20)] = {1: [(6,20),(4,20)], 3: [(7,21),(7,19),(2,20),(3,19)], 5: [(9,21),(7,23),(6,18),(4,18),(3,17),(0,20),(8,20)],ORANGE:(8,20)}
    ...
    def init_row4(self):
        ...
        self.transition_dict[(4, 16)] = {1: [(5,16),(3,16)], 3: [(5,18),(3,18),(3,14),(7,16)], 5: [(7,18),(3,20),(3,18),(8,17),(3,12),(7,14),(9,16)]}
        self.transition_dict[(4, 14)] = {1: [(3,14)], 3: [(3,16),(3,12)], 5: [(4,11),(2,11),(3,10),(1,12),(5,16),(3,18)]}
        self.transition_dict[(4, 11)] = {1: [(4,10),(5,11),(3,11)], 3: [(7,11),(1,11),(3,13),(3,9),(4,8),(5,13),(2,12)], 5: [(3,15),(4,8),(2,8),(3,7),(7,13),(8,10),(7,9),(6,8),(4,6)], ORANGE: (5,13)}
        self.transition_dict[(4, 10)] = {1: [(4,9)], 3: [(5,8),(4,7),(3,8)], 5: [(5,10)]}
        self.transition_dict[(5, 10)] = {1: [(4,9)], 3: [(5,8),(4,7),(3,8)], 5: [(4,5),(7,8),(3,10),(3,6),(1,8)], ORANGE: (4,5), GET: 500}
        self.transition_dict[(4, 9)] = {1: [(4,8)], 3: [(6,8),(4,6),(3,7),(2,8),(3,9)], 5: [(0,8),(3,11),(3,5),(7,9),(8,8),(7,7)]}
        self.transition_dict[(4, 8)] = {1: [(5,8),(3,8),(4,7)], 3: [(4,5),(1,8),(3,10),(7,8)], 5: [(3,12),(4,11),(2,11),(3,4),(8,7),(8,9),(7,10),(7,6)], ORANGE: (4,5)}
    ...
    def init_row3(self):
        ...
        self.transition_dict[(3, 25)] = {1: [(2,25),(4,25)], 3: [(0,25),(3,26),(6,25)], 5: [(0,27),(0,23),(6,27),(8,25),(7,24)], ORANGE: [(3,26)]}
        ...
        self.transition_dict[(3, 16)] = {1: [(3,17),(3,15),(4,16)], 3: [(3,19),(4,18),(5,17),(6,16),(3,13)], 5: [(8,18),(7,17),(7,15),(6,18),(4,18),(2,12),(3,11)]}
        self.transition_dict[(3, 15)] = {1: [(3,16),(3,14)], 3: [(5,16),(3,18),(3,12)], 5: [(4,11),(3,10),(2,11),(7,16),(5,18),(3,20),(1,23)]}
        self.transition_dict[(3, 14)] = {1: [(3,15),(3,13)], 3: [(2,12),(3,11),(4,16),(3,17)], 5: [(5,17),(6,16),(1,13),(3,19),(4,18),(5,11),(1,11),(3,9),(2,12)]}
        self.transition_dict[(3, 13)] = {1: [(3,14),(3,12)], 3: [(3,16),(1,12),(3,10),(2,11),(4,11)], 5: [(3,18),(5,16),(2,13),(5,12),(3,8),(0,11),(6,11),(1,12)]}
        self.transition_dict[(3, 12)] = {1: [(3,13),(3,11),(2,12)], 3: [(3,15),(2,12),(1,13),(1,11),(5,11),(4,10),(3,9)], 5: [(3,17),(4,16),(4,8),(2,8),(3,7),(7,11)], ORANGE: (5,13)}
        self.transition_dict[(3, 11)] = {1: [(3,12),(3,10),(2,11),(4,11)], 3: [(3,14),(0,11),(1,12),(6,11),(3,8)], 5: [(3,16),(2,13),(5,8),(7,12),(7,10),(3,6),(1,8),(4,7)]}
        self.transition_dict[(3, 10)] = {1: [(3,11),(3,9)], 3: [(3,13),(1,11),(5,11),(3,13),(4,10),(4,8),(3,7),(2,8)], 5: [(5,13),(3,15),(4,8),(1,13),(6,8),(0,8),(3,5),(7,11)]}
        self.transition_dict[(3, 9)] = {1: [(3,8),(3,10)], 3: [(4,11),(3,12),(2,11),(5,8),(1,8),(3,6),(4,7)], 5: [(5,12),(0,11),(3,14),(0,8),(3,4),(7,8),(6,11),(4,9),(4,5)], ORANGE: (4,5)}
        self.transition_dict[(3, 8)] = {1: [(3,9),(3,7),(4,8),(2,8)], 3: [(6,8),(3,11),(3,5),(0,8),(4,6)], 5: [(3,13),(1,11),(2,12),(0,11),(4,10),(8,8),(4,4),(2,4),(7,9),(7,7),(5,11)]}
        self.transition_dict[(3, 7)] = {1: [(3,8),(3,6)], 3: [(4,7),(3,10),(5,8),(1,8),(3,4)], 5: [(7,8),(3,12),(4,5),(1,4),(5,4),(4,11),(2,11),(0,9)], ORANGE: (4,5)}
    ...
    def init_row1(self):
        self.transition_dict[(1, 25)] = {1: [(0,25),(2,25)], 3: [(0,27),(0,23),(4,25),(3,26)], 5: [(0,21),(6,25)], ORANGE: (3,26)}
        ...
        self.transition_dict[(1, 12)] = {1: [(1,13)], 3: [(2,14)], 5: [(1,15)], WAIT: 1, PAY: 50, ORANGE: (1,15)}
    ...
    def init_row0(self):
        ...
        self.transition_dict[(0, 26)] = {1: [(0,27),(0,25)], 3: [(2,25),(0,23)], 5: [(3,26),(4,25),(0,21)], ORANGE: (3,26)}
        self.transition_dict[(0, 25)] = {1: [(0,26),(1,25),(0,24)], 3: [(2,26),(3,25),(0,22)], 5: [(5,25),(0,20)]}
        self.transition_dict[(0, 24)] = {1: [(0,25),(0,23)], 3: [(2,25),(0,27),(0,21)], 5: [(3,26),(4,25),(1,20)], ORANGE: (3,26)}
