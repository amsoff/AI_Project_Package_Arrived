...
class Board:
    ...
    def init_row11(self):
        correction = {
            ...
            (11, 20): {1: [(11, 19)], 3: [(12, 18)], 5: [(12, 20), (11, 17), (14, 18)], JUMP: [], PAY: 200},
            # (11, 19): {1: [(11, 18)], 3: [(12, 19), (12, 17), (13, 18)],5: [(15, 18), (12, 21), (13, 20), (10, 17), (11, 16)], JUMP: []},
            (11, 19): {1: [(4, 29)], 3: [(4, 29)],5: [(4, 29)], JUMP: []},
    ...
    def init_row10(self):
        ...
        self.transition_dict[(10, 20)] = {1: [(11,20)], 3:[(11,18)], 5:[(12,19),(12,17),(13,18)], JUMP:[], PAY: 150}
    ...
    def init_row7(self):
        ...
        self.transition_dict[(7, 24)] = {1: [(7, 25),(7,23)], 3: [(7,21),(6,22), (9,25),(5,25),(6,26)], 5: [(8,20), (9,21), (7,19) ,(6,20),(11,25),(6,28),(3,25),(6,24)], JUMP: []}
        self.transition_dict[(7, 23)] = {1: [(7, 24),(7,22)], 3: [(8,21), (7,20),(8,25),(6,25)], 5: [(10,25), (6,27), (4,25) ,(10,21),(8,20),(7,18),(5,20)], JUMP: []}
        self.transition_dict[(7, 22)] = {1: [(7, 23),(7,21),(6,22)], 3: [(7,25), (8,20),(9,21),(7,19),(6,20),(6,24)], 5: [(9,25), (6,26), (5,25) ,(4,20),(6,18),(11,21),(5,20),(5,23)], JUMP: []}
        self.transition_dict[(7, 21)] = {1: [(7, 22),(7,20),(8,21)], 3: [(7,24), (10,21),(7,18),(5,20),(8,20)], 5: [(8,20), (8,25), (6,25) ,(12,21),(5,18),(3,20)], JUMP: []}
        self.transition_dict[(7, 20)] = {1: [(7, 21),(7,19),(6,20)], 3: [(6,18), (4,20),(8,20),(7,23),(7,17),(6,22)], 5: [(7,25), (2,20), (4,18) ,(8,20),(11,21),(6,16),(17,15),(9,17),(6,24)], JUMP: []}
    ...
    def init_row4(self):
        ...
        self.transition_dict[(4, 5)] = {1: [(4,4)], 3: [(6,4),(2,4),(3,5)], 5: [(3,7),(7,5),(8,4),(7,3)], JUMP: [], PAY: 50}
    ...
    def init_row2(self):
        self.transition_dict[(2, 29)] = {1: [(2,28)], 3: [(4,28)], 5: [(5,29),(6,28)], JUMP: []}
        self.transition_dict[(2, 28)] = {1: [(3,28)], 3: [(5,28)], 5: [(5,30),(7,28),(6,27)], JUMP: []}
        self.transition_dict[(2, 26)] = {1: [(3,26)], 3: [(3,26)], 5: [(3,26)], JUMP: []}
        self.transition_dict[(2, 25)] = {1: [(3,25),(1,25)], 3: [(5,25),(0,26),(0,24),(3,26)], 5: [(3,26),(0,22),(6,26),(7,25)], JUMP: []}
        self.transition_dict[(2, 20)] = {1: [(1,20),(3,20)], 3: [(0,21),(3,18),(5,20)], 5: [(0,23),(7,20),(5,18),(3,16)], JUMP: []}
        self.transition_dict[(2, 15)] = {1: [(3,15)], 3: [(3,13),(3,17),(4,16)], 5: [(5,17),(3,11),(6,16),(3,19),(4,18)], JUMP: []}
        self.transition_dict[(2, 14)] = {1: [(1,14)], 3: [(3,16),(3,14)], 5: [(3,12),(5,16),(3,18)], JUMP: []}
        self.transition_dict[(2, 13)] = {1: [(2,14)], 3: [(1,15)], 5: [(1,15)], JUMP: [], PAY: 50}
        self.transition_dict[(2, 12)] = {1: [(1,12)], 3: [(2,13)], 5: [(1,14)], JUMP: []}
        self.transition_dict[(2, 11)] = {1: [(1,11),(3,11)], 3: [(5,11),(3,13),(3,9),(1,13)], 5: [(2,14),(3,15),(7,11),(5,13)], JUMP: []}
        self.transition_dict[(2, 8)] = {1: [(1,8),(3,8)], 3: [(0,9),(3,10),(5,8),(3,6),(4,7)], 5: [(3,12),(4,11),(2,11),(4,5),(7,8),(3,4)], JUMP: []}
        self.transition_dict[(2, 4)] = {1: [(1,4),(3,4)], 3: [(5,4),(3,6)], 5: [(7,4),(3,8)], JUMP: []}


    def init_row1(self):
        self.transition_dict[(1, 25)] = {1: [(0,25),(2,25)], 3: [(0,27),(0,23),(4,25),(3,26)], 5: [(3,26),(0,21),(6,25)], JUMP: []}
        self.transition_dict[(1, 20)] = {1: [(0,20),(2,20)], 3: [(0,22),(3,19),(4,20)], 5: [(0,24),(6,20),(4,18),(3,17)], JUMP: []}
        self.transition_dict[(1, 15)] = {1: [(2,15)], 3: [(3,16),(3,14)], 5: [(3,18),(5,16),(3,12)], JUMP: [], PAY: 50}
        self.transition_dict[(1, 14)] = {1: [(0,14)], 3: [(0,14)], 5: [(0,14)], JUMP: []}
        self.transition_dict[(0, 14)] = {1: [(1,15)], 3: [(1,15)], 5: [(1,15)], JUMP: []}
        self.transition_dict[(1, 13)] = {1: [(0,13)], 3: [(0,13)], 5: [(0,13)], JUMP: []}
        self.transition_dict[(0, 13)] = {1: [(2,13)], 3: [(1,14)], 5: [(1,15)], JUMP: []}
        self.transition_dict[(1, 12)] = {1: [(0,12)], 3: [(0,12)], 5: [(0,12)], JUMP: [], PAY: 50}
        self.transition_dict[(0, 12)] = {1: [(1,13)], 3: [(2,14)], 5: [(1,15)], JUMP: []}
        self.transition_dict[(1, 11)] = {1: [(0,11),(2,11)], 3: [(1,12),(3,12),(3,10),(4,11)], 5: [(1,15),(5,12),(6,11),(3,14),(3,8),(4,9)], JUMP: []}
        self.transition_dict[(1, 8)] = {1: [(0,8),(2,8)], 3: [(0,11),(3,9),(3,7),(4,8)], 5: [(1,11),(3,11),(6,8),(3,5),(4,6)], JUMP: []}
        self.transition_dict[(1, 4)] = {1: [(0,4),(2,4),(1,0)], 3: [(3,5),(4,4)], 5: [(6,4),(3,7),(6,8),(3,5),(4,6)], JUMP: []}
        # starting point
        self.transition_dict[(1, 0)] = {1: [(1,4)], 3: [(3,4)], 5: [(3,6),(5,4)], JUMP: []}


    def init_row0(self):
        self.transition_dict[(0, 27)] = {1: [(0,26)], 3: [(1,25),(0,24)], 5: [(2,26),(3,25),(0,22)], JUMP: []}
        self.transition_dict[(0, 26)] = {1: [(0,27),(0,25)], 3: [(2,25),(0,23)], 5: [(3,26),(4,25),(0,21)], JUMP: []}
        self.transition_dict[(0, 25)] = {1: [(0,26),(1,25),(0,24)], 3: [(2,26),(3,25),(0,22)], 5: [(3,26),(5,25),(0,20)], JUMP: []}
        self.transition_dict[(0, 24)] = {1: [(0,25),(0,23)], 3: [(2,25),(0,27),(0,21)], 5: [(3,26),(4,25),(1,20)], JUMP: []}
        self.transition_dict[(0, 23)] = {1: [(0,24),(0,22)], 3: [(1,25),(0,26),(0,20)], 5: [(2,26),(3,25),(2,20)], JUMP: []}
        self.transition_dict[(0, 22)] = {1: [(0,23),(0,21)], 3: [(0,25),(1,20)], 5: [(2,25),(0,27),(3,20)], JUMP: []}
        self.transition_dict[(0, 21)] = {1: [(0,22),(0,20)], 3: [(0,24),(2,20)], 5: [(1,25),(0,26),(4,20),(3,19)], JUMP: []}
        self.transition_dict[(0, 20)] = {1: [(0,21),(1,20)], 3: [(0,23),(3,20)], 5: [(0,25),(5,20),(3,18)], JUMP: []}
        self.transition_dict[(0, 11)] = {1: [(1,11)], 3: [(3,11),(2,12)], 5: [(1,13),(3,13),(5,11),(3,9)], JUMP: []}
        self.transition_dict[(0, 9)] = {1: [(0,11)], 3: [(2,11)], 5: [(3,12),(4,11),(3,10)], JUMP: []}
        self.transition_dict[(0, 4)] = {1: [(1,4)], 3: [(3,4)], 5: [(3,6),(5,4)], JUMP: []}
