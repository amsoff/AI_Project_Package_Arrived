...
class Board:
    ...
    def init_row10(self):
        ...
        self.transition_dict[(10, 5)] = {1: [(9, 5), (11, 5)],
                                         2: [(9, 6), (8, 5), (9, 4)],
                                         3: [(9, 7), (7, 5), (9, 3)]}
    ...
    def init_row9(self):
        ...
        self.transition_dict[(9, 2)] = {1: [(8, 2), (9, 1), (9, 3)],
                                        2: [(8, 1), (9, 0), (8, 3), (9, 4)],
        ...
        self.transition_dict[(9, 3)] = {1: [(9, 4), (9, 2)],
                                        2: [(9, 1), (8, 2), (9, 5)],
                                        3: [(9, 6), (10, 5), (8, 5), (8, 1), (8, 3), (9, 0)]}

        self.transition_dict[(9, 4)] = {1: [(9, 3), (9, 5)],
                                        2: [(8, 5), (10, 5), (9, 2), (9, 6)],
                                        3: [(7, 5), (9, 1), (11, 5), (8, 2), (9, 7)]}

        self.transition_dict[(9, 5)] = {1: [(9, 4), (8, 5), (9, 6), (10, 5)],
                                        2: [(7, 5), (11, 5), (9, 3), (9, 7)],
                                        3: [(7, 6), (9, 8), (9, 2), (6, 5)],
                                        SURPRISE: True,
                                        GOTO: [(2, 5), (5, 10), (7, 10), (8, 4), (11, 11)]}
        ...
        self.transition_dict[(9, 6)] = {1: [(9, 7), (9, 5)],
                                        2: [(8, 5), (10, 5), (9, 4), (9, 8)],
                                        3: [(10, 8), (8, 8), (7, 5), (9, 3), (11, 5)]}

        self.transition_dict[(9, 7)] = {1: [(9, 8), (9, 6)],
                                        2: [(8, 8), (9, 5), (10, 8)],
                                        3: [(10, 7), (7, 8), (10, 5), (8, 5), (9, 4)]}
        ...
        self.transition_dict[(9, 11)] = {1: [(10, 11)],
                                         2: [(11, 11)],
                                         3: [(9, 11)],
                                         ORANGE: [(11, 11)],
    ...
    def init_row8(self):
        ...
        self.transition_dict[(8, 1)] = {1: [(9, 1), (7, 1)],
                                        2: [(9, 2), (6, 1), (9, 0)],
                                        3: [(10, 0), (8, 0), (5, 1), (8, 2), (9, 3)]}

        self.transition_dict[(8, 2)] = {1: [(8, 3)],
                                        2: [(8, 4)],
                                        3: [(8, 2)],
                                        ORANGE: [(8, 4)],
        ...
        self.transition_dict[(8, 4)] = {1: [(8, 5)],
                                        2: [(9, 5), (7, 5)],
                                        3: [(7, 6), (6, 5), (9, 6), (9, 4), (10, 5)],
                                        BALANCE: -50,  # negative
                                        GOTO: [(1, 6)],
                                        HAS: Certificate.PASSPORT,
                                        ENTRANCE: [(8, 5)]}

        self.transition_dict[(8, 5)] = {1: [(7, 5), (9, 5)],
                                        2: [(7, 6), (6, 5), (9, 6), (9, 4), (10, 5)],
                                        3: [(6, 6), (6, 4), (9, 7), (9, 3), (5, 5), (11, 5)]}
    ...
    def init_row7(self):
        ...
        self.transition_dict[(7, 8)] = {1: [(8, 8), (6, 8)],
                                        2: [(5, 8), (9, 8)],
                                        3: [(10, 8), (9, 7), (5, 9), (5, 7)],
                                        ORANGE: [(5, 9)]}

        self.transition_dict[(7, 6)] = {1: [(6, 6)],
                                        2: [(6, 7)],
                                        3: [(7, 6)],
                                        ORANGE: [(6, 7)],
                                        WAIT: 1,
    ...
    def init_row6(self):
        ...
        self.transition_dict[(6, 7)] = {1: [(5, 7)],
                                        2: [(5, 8), (5, 6)],
                                        3: [(5, 9), (6, 8), (4, 6), (5, 5)],
        ...
        self.transition_dict[(6, 5)] = {1: [(7, 5), (5, 5), (6, 4)],
                                        2: [(8, 5), (7, 6), (5, 6), (6, 3)],
                                        3: [(9, 5), (6, 6), (5, 7), (4, 6), (6, 2)]}

        self.transition_dict[(6, 4)] = {1: [(6, 3)],
                                        2: [(6, 2)],
                                        3: [(5, 2)],
                                        ORANGE: [(5, 2)],
                                        MESSAGE: "!!! POLICE !!! You are at the police station"}

        self.transition_dict[(6, 3)] = {1: [(6, 2)],
                                        2: [(5, 2)],
                                        3: [(6, 3)],
                                        ORANGE: [(5, 2)]}
    ...
    def init_row5(self):
        ...
        self.transition_dict[(5, 7)] = {1: [(5, 8), (5, 6)],
                                        2: [(6, 8), (5, 5), (4, 6), (5, 9)],
                                        3: [(6, 5), (4, 5), (4, 7), (7, 8), (3, 6)],
                                        ORANGE: [(5, 9)]}

        self.transition_dict[(5, 6)] = {1: [(5, 7), (5, 5), (4, 6)],
                                        2: [(5, 8), (6, 5), (4, 7), (4, 5), (3, 6)],
                                        3: [(5, 9), (6, 8), (4, 4), (3, 5), (6, 4), (7, 5)],
                                        ORANGE: [(5, 9)]}

        self.transition_dict[(5, 5)] = {1: [(6, 5), (5, 6)],
                                        2: [(6, 4), (5, 7), (4, 6), (7, 5)],
                                        3: [(5, 8), (4, 7), (4, 5), (3, 6), (7, 6), (8, 5), (6, 3)]}
    ...
    def init_row4(self):
        ...
        self.transition_dict[(4, 5)] = {1: [(4, 4)],
                                        2: [(4, 3)],
                                        3: [(4, 5)],
                                        ORANGE: [(4, 3)],
    ...
    def init_row2(self):
        self.transition_dict[(2, 5)] = {1: [(1, 6)],
                                        2: [(1, 5)],
                                        3: [(1, 4)],
                                        ORANGE: [(1, 4)],
                                        BALANCE: -50,
    ...
    def init_row1(self):
        ...
        self.transition_dict[(1, 3)] = {1: [(1, 2)],
                                        2: [(1, 1), (2, 2), (2, 4)],
                                        3: [(2, 1), (1, 0), (3, 2), (3, 4), (2, 5)]}

        self.transition_dict[(1, 2)] = {1: [(2, 2), (1, 1)],
                                        2: [(1, 0), (2, 1), (3, 2), (2, 3)],
                                        3: [(4, 2), (2, 4), (3, 3), (0, 0)]}

        self.transition_dict[(1, 1)] = {1: [(1, 0), (1, 2), (2, 1)],
                                        2: [(0, 0), (2, 2)],
                                        3: [(0, 1), (3, 2), (2, 3)],
                                        ORANGE: [(0, 1)]}

        self.transition_dict[(1, 0)] = {1: [(0, 0), (1, 1)],
                                        2: [(0, 1), (1, 2), (2, 1)],
                                        3: [(2, 2)],
                                        ORANGE: [(0, 1)]}
